...
export default function Home() {
    ...
    return (
        <div className="min-h-screen flex flex-col">
            <main className="flex-1 py-8 px-4 relative flex items-center justify-center">
                ...
                >
                    <svg className="w-full h-full" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <rect width="100%" height="100%" fill="url(#grid)" className="text-slate-300" opacity="0.3" />
            ...
            {/* Subtle Copyright Notice - Always at bottom */}
            <footer className="py-4 px-4">
                <motion.div
                    className="text-center text-xs text-slate-400 opacity-60 hover:opacity-100 transition-opacity duration-300"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 0.6 }}
